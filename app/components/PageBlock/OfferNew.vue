...
<template>
  <section class="relative flex flex-col h-[700px] md:h-[790px] mb-[120px]">
    ...
    <div
      class="fixed top-0 left-0 right-0 z-50 py-5 border-b transition-colors duration-300"
      ...
      <div class="flex container items-center justify-between">
        ...
        <nuxt-link to="/" class="flex items-end gap-2">
          <svg width="28" height="27" viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_681_5991)">
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M8.40973 3.26215V26.7766H5.35834V3.26215H0V0H13.7821V3.26215H8.40973Z" fill="white"/>
            </g>
            <defs>
        ...
        <nav class="hidden lg:flex items-center gap-[42px]">
          ...
          <div class="flex items-center gap-3">
            <a href="tel:+79685458877" target="_blank" aria-label="Телефон" class="p-[10px]  border border-white rounded-md hover:bg-white/10 transition-colors">
            ...
            <a href="https://t.me/texnoreal_company" target="_blank" aria-label="Telegram" class="p-[10px]  border border-white rounded-md hover:bg-white/10 transition-colors">
